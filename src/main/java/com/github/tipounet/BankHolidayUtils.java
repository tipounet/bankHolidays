 ...
 */
public final class BankHolidayUtils {
    ...
    /**
     * Calcul le jour de pâques pour l'annee {@code year}
     * <p>
     ...
     *
     * @param year année dans laquelle on souhaite le jour de pâques
     ...
     *
     * @param year année dont l'on souhaite trouver le jour de pâque
     * @return le jour de pâque pour l'année {@code year}
     */
    LocalDate getEasterDayConwayMethod(final int year) {
        ...
        final int R = 57 - d - f - h; // Dimanche de pâques
        int day;
        Month month;
        if (R <= 31) {
            day = R;
     ...
     * lundi de pâques
     *
     * @param easterDay date de pâques
     * @return lundi de paque
     */
    LocalDate getMondayOfEasterDay(final LocalDate easterDay) {
     ...
     *
     * @param easterDay date de pâques²
     * @return date du jeudi de pentecote
     */
    LocalDate getAscension(final LocalDate easterDay) {
        assert easterDay != null;
     ...
     * Lundi de pentecote
     *
     * @param easterDay date de paque
     * @return lundi de pentecote
     */
    LocalDate getMondayOfPentecote(final LocalDate easterDay) {
        assert easterDay != null;
        return easterDay.plus(50, ChronoUnit.DAYS);
    }

    /**
     * Verifie si la date est un jour férie.
     *
     * @param date la date à tester
     * @return {@code true} si la date est un jour fériée
     */
